...
{    
    ...
    {
        /*
        _topArrowImage = [UIImage tallImageNamed:@"popover-black-top-arrow-image.png"];
        _leftArrowImage = [UIImage tallImageNamed:@"popover-black-left-arrow-image.png"];
        _bottomArrowImage = [UIImage tallImageNamed:@"popover-black-bottom-arrow-image.png"];
        _rightArrowImage = [UIImage tallImageNamed:@"popover-black-right-arrow-image.png"];
        */
